...
python eval.py --reader_model_id unsloth/mistral-7b-v0.3 --sampling_params cfg/mistral_7b.json
python eval.py --reader_model_id unsloth/mistral-7b-v0.3 --sampling_params cfg/mistral_7b.json --embedder_model_id BAAI/bge-large-en-v1.5 --reranker_model_id BAAI/bge-reranker-v2-m3
